...
contract OTMarket is ReentrancyGuard{
    using Counters for Counters.Counter;
    // number of items minting, number of transactions, tokens that have not been sold
    // keep track of tokens total number - tokenId
    // arrays need to know the leng - help to keep track of the number of items
    ...
    // listen to events from front end app
    ...
    // 1. create a new item to put it on sale
    // 2. create a market a sale for buying and selling between parties
    ...
    public payable nonReentrant{
        ...
        // putting it up for sale - bool - noOwner
        ...
        function createMarketSale(
            ...
            public payable nonReentrant{
                ...
                require(msg.value == price, 'Price must match the listing price');

                // transafer the amount to seller
                idToMarketToken[itemId].seller.transfer(msg.value);
                // transfer the token from contract address to buyer
        ...
        function fetchMyNFTs() public view returns(MarketToken[] memory){
            ...
            // check to see if the owner address is equal to the msg.sender
